                ...
                <div class="container h-100">
                    ...
                    <div class="col col-xl-10">
                        ...
                        <div class="row g-0">
                            ...
                            <form method="post" action="{{ url('/employee/confirm') }}">
                            {{csrf_field()}}
                                <div class="align-items-center mb-1">
                                    <a href="{{ url('/') }}">
                                        <img src="{{URL::asset('/images/TextLogo.png')}}" alt="Logo" height="auto" width="230">
                                    </a>
                                </div>
                                <br>
                                <h5 class="fw-body mb-3 pb-3" style="letter-spacing: 1px;">Please confirm your Id & Email</h5>

    ...
    <body>
        <div class="shadow p-0 mb-1 bg-white rounded">
            ...
            <nav class="navbar navbar-expand-md navbar-light bg-light">
              ...
              <div class="container">
                <!-- Navbar brand -->
                <a class="navbar-brand me-2" href="{{ url('/employee/home/'.$name.'/'.$email.'') }}">
                  <img
            ...
            <div class="row">
                ...
                <div class="col-8">
                    <div class="shadow bg-white rounded">
                        <form action="{{url('/employee/save/profile')}}" method="post">
                            {{csrf_field()}}
                            <div class="card p-1" style="border: 1;">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-4">
                                        <label for="">ID</label>
                                        <input type="text" name="id" readonly tabindex="-1" value="{{$employee->id}}" class="form-control" required>
                                    </div>
                                    <div class="col-4">
                                        <label for="">Email</label>
                                        <input type="text" name="email" readonly tabindex="-1" value="{{$employee->email}}" class="form-control">
                                    </div>
                                </div>
                                <br>
                                <div class="row">
                                    ...
                                    <div class="col-4">
                                        ...
                                        <input type="text" name="role" readonly tabindex="-1" value="{{$employee->role}}" class="form-control" required>
                                    </div>
                                    <div class="col-4">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-4">
                                        ...
                                        <input type="text" name="gender" value="{{$employee->gender}}" class="form-control" required>
                                    </div>
                                </div>
                                <br>
                                <div class="row">
                                    ...
                                    <div class="col-4">
                                        ...
                                        <input type="tel" name="contact_number" value="{{$employee->contact_number}}" class="form-control" required>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-12">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-4">
                                        ...
                                        <div class="input-group mb-3">
                                            <input type="password" name="current_password" required id="current_password" value="{{$employee->password}}" class="form-control">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-4">
                                        ...
                                        <div class="input-group mb-3">
                                            <input type="password" name="new_password" required id="new_password" value="{{$employee->password}}" class="form-control">
                                            <div class="input-group-append">
                                    ...
                                    <div class="col-4">
                                        ...
                                        <div class="input-group mb-3">
                                            <input type="password" name="confirm_password" required id="confirm_password" value="{{$employee->password}}" class="form-control">
                                            <div class="input-group-append">
                ...
                <div class="col-2">
                    @if($message = Session::get('message'))
                        <div class="alert alert-success alert-dismissible fade show">
                            {{$message}}
                            <a href="{{ url('/employee/home/'.$name.'/'.$email.'') }}"><button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button></a></button>
                        </div>
                    @else
                        <br>
                    @endif

                ...
                <div class="shadow bg-white rounded">
                    <div class="card p-1" style="border: 0;">
                        ...
                        @else
                            ...
                            <a href="{{url('/employee/stocks/'.$name.'/'.$email.'')}}" class="btn btn-primary"><i class="bi bi-boxes"></i></i><br> Stocks</a>
                            @else
                            <a href="{{url('/employee/stocks/'.$name.'/'.$email.'')}}" class="btn btn-primary disabled"><i class="bi bi-boxes"></i></i><br> Stocks</a>
                            @endif
                            <br>
                            <br>
                        ...
                        <br>
                          <div class="row">
                            ...
                            @if($resultcount > 0)
                              <div class="col-3">
                                @if($auth_level == 1)
                                  <a href="{{url('/employee/'.$name.'/'.$email.'/'.$stat.'/create/stockreport')}}" role="button" class="btn btn-info btn-block"><i class="bi bi-file-earmark-arrow-down"></i> Downlaod Report</a>
                                @elseif($auth_level == 2)
                                  <a href="{{url('/employee/'.$name.'/'.$email.'/'.$stat.'/create/stockreport')}}" role="button" class="btn btn-info btn-block"><i class="bi bi-file-earmark-arrow-down"></i> Downlaod Report</a>
                                @elseif($auth_level == 3)
                                  <a href="{{url('/employee/'.$name.'/'.$email.'/'.$stat.'/create/stockreport')}}" role="button" class="btn btn-info btn-block"><i class="bi bi-file-earmark-arrow-down"></i> Downlaod Report</a>
                                @else
                                  <a href="{{url('/employee/'.$name.'/'.$email.'/'.$stat.'/create/stockreport')}}" role="button" class="btn btn-info btn-block" disabled><i class="bi bi-file-earmark-arrow-down"></i> Downlaod Report</a>
                                @endif
                              </div>
                            @else
                              <div class="col-3">

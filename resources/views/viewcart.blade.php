                          ...
                          <div class="card-body">
                            ...
                            <div class="row">
                              ...
                              <div class="col-lg-5 col-md-6 mb-4 mb-lg-0">
                                ...
                                <p class="lead"><b><i>{{$cart->product_name}}</i></b></p>
                                <input type="hidden" name="product_name[]" value="{{$cart->product_name}}">
                                <p>Color: {{$cart->colour}} <img src="{{URL::asset('/colours/'.$cart->colour.'.png')}}" width="15px" height="15px" class="rounded-circle"></p>
                          ...
                          <div class="shadow p-0 mb-1 bg-white rounded">
                            <div class="card mb-4">
                              ...
                              <div class="card-body">
                                ...
                                <a class="btn btn-primary btn-block" data-toggle="collapse" href="#info" role="button" aria-expanded="false" aria-controls="address">
                                  Confirm Order
                                </a>

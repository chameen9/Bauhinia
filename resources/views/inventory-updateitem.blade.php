      ...
      <div class="container-fluid">
        <div class="row">
            <div class="col-lg-1 col-md-1 col-sm-2">
                <div class="shadow bg-white rounded">
                    <div class="card p-1" style="border: 0;">
                        <br>
                        <a href="" class="btn btn-outline-primary disabled"><i class="bi bi-house"></i><br> Home</a>
                        <br>
                        <br>
                        <a href="" class="btn btn-outline-primary disabled"><i class="bi bi-shop"></i><br> Orders</a>
                        <br>
                        <br>
                        <a href="{{url('/employee/inventory/'.$name.'/'.$email.'')}}" class="btn btn-primary"><i class="bi bi-card-checklist"></i><br> Inventory</a>
                        <br>
                        <br>
                        <a href="" class="btn btn-outline-primary disabled"><i class="bi bi-coin"></i><br> Money</a>
                        <br>
                        <br>
                        <a href="#users" class="btn btn-outline-primary disabled"><i class="bi bi-person-plus"></i><br> Users</a>
                        <br>
                        <br>
                        <br>
                    </div>
            ...
            <div class="col-lg-11 col-md-11 col-sm-9">
                <div class="shadow bg-white rounded">
                    <div class="card p-1" style="border: 0;">
                        <form action="{{url('/employee/inventoryupdatestock/update')}}" method="post">
                        {{csrf_field()}}
                        <br>

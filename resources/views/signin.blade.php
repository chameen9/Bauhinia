                ...
                <div class="container h-100">
                    ...
                    <div class="col col-xl-10">
                        ...
                        <div class="row g-0">
                            ...
                            <form method="post" action="{{ url('/customer/checksignin') }}">
                            {{csrf_field()}}
                                ...
                                @if(count($errors)>0 || $message = Session::get('error'))
                                    @if(count($errors)>0)
                                        ...
                                        @foreach($errors->all() as $error)
                                            <li>{{ $error }}</li>
                                            <a href="{{ url('/customer/signin') }}"><button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button></a></button>
                                        @endforeach
                                        </ul>
                                        </div>
                                    @endif

                        ...
                        <div class="row g-0">
                            ...
                            {{csrf_field()}}
                                ...
                                <div class="form-outline mb-4">
                                    <label class="body">Employee Id</label>
                                    <input type="text" required name="id" class="form-control" placeholder="BH**-*****">
                                </div>
    
                                <div class="form-outline mb-3">
                                    <label class="body">Email</label>
                                    <input type="email" name="email" required class="form-control" placeholder="name@bahiniya.lk" data-mdb-showcounter="true" maxlength="100">
                                </div>
                                <br>
                                <div class="body">
                                ...
                                <p class="body" style="color: #393f81;">Don't have an account? <a href="{{ url('/empsignup') }}" class="link-primary">Sign up here</a></p>
                                @if(count($errors)>0 || $message = Session::get('error'))
                                    @if(count($errors)>0)
                                        ...
                                        @foreach($errors->all() as $error)
                                            <li>{{ $error }}</li>
                                            <a href="{{ url('/confirm') }}"><button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button></a></button>
                                        @endforeach
                                        </ul>
                                        </div>
                                    @endif

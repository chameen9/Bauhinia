    ...
    <body>
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
            <div class="shadow p-3 mb-5 bg-white rounded">
              <div class="box-part text-center">
                <img src="{{URL::asset('/images/5.JPG')}}" width="300px" height="300px" class="img-fluid rounded-circle">
              <div class="title">
          ...
          <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
            <div class="shadow p-3 mb-5 bg-white rounded">
              <div class="box-part text-center">
                <img src="{{URL::asset('/images/4.JPG')}}" width="300px" height="300px" class="img-fluid rounded-circle">
              <div class="title">
                <h5>Western Wear</h5>
              </div>
              <div class="text">
          ...
          <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
            <div class="shadow p-3 mb-5 bg-white rounded">
              <div class="box-part text-center">
                <img src="{{URL::asset('/images/6.JPG')}}" width="300px" height="300px" class="img-fluid rounded-circle">
              <div class="title">
                <h5>Ethnic Wear</h5>
              </div>
              <div class="text">
              ...
              <a class="btn btn-outline-success" href="#" role="button">Shop Now</a>
              </div>
            </div>
          </div>	
          ...
          <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
            <div class="shadow p-3 mb-5 bg-white rounded">
              <div class="box-part text-center">
                <img src="{{URL::asset('/images/8.JPG')}}" width="300px" height="300px" class="img-fluid rounded-circle">
              <div class="title">
        ...
        <div class="row">
          <div class="col-12">
            <h3 align="center" class="display-5">Categories To Shop</h3>
            <br>
          </div>
        </div>
      ...
      <footer class="text-center text-lg-start bg-light text-muted">
        ...
        >
          ...
          <!-- Right -->
          <div>
            <a href="https://facebook.com/BauhiniyaLK" class="me-4 text-reset"><i class="bi bi-facebook"></i></a>
            <a href="https://twitter.com/BauhiniyaLK" class="me-4 text-reset"><i class="bi bi-twitter"></i></a>
            <a href="https://google.com/BauhiniyaLK" class="me-4 text-reset"><i class="bi bi-google"></i></a>
            <a href="https://instagram.com/bauhiniya_lk" class="me-4 text-reset"><i class="bi bi-instagram"></i></a>
            <a href="https://linkedin.com/BauhiniyaLK" class="me-4 text-reset"><i class="bi bi-linkedin"></i></a>
          </div>
            <!-- Right -->
            </section>
            <!-- Section: Social media -->
                ...
                <div class="row mt-3">
                  ...
                  <div class="col-md-3 col-lg-4 col-xl-3 mx-auto mb-4">
                    ...
                    <p class="text-justify">
                      Bauhiniya is one of the emerging retail brand clothing store among the retail industries. We provide wide range of clothing, footwear and accessories to all customers at an affordable price yet with a splendid quality. We have all kind of items for Men, Women & Kids for a family shopping with recent fashion trend and also we are introducing new designs for all seasons.
                    </p>
                  </div>
                  <!-- Grid column -->
                  ...
                  <div class="col-md-4 col-lg-3 col-xl-3 mx-auto mb-md-0 mb-4">
                    ...
                    <p><i class="bi bi-telephone-fill"></i> +94 71 401 7271</p>
                  </div>
                  <!-- Grid column -->
                </div>
                <!-- Grid row -->
            ...
            <div class="text-center p-4" style="background-color: rgba(0, 0, 0, 0.05);">
              Bauhiniya &copy; 2022. All Rights Reserved. <br>
              Designed by: 
              <a class="text-reset" href="https://facebook.com/AKL Software">AKL Software</a>
            </div>
            <!-- Copyright -->
          </footer>
          <!-- Footer -->
